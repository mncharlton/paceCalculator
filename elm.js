...
var $author$project$PaceCalculator$initialModel = {distanceUnit: 'none', kilometres: 0, kmPace: 0, milePace: 0, miles: 0, timeHours: 0, timeMinutes: 0, timeSeconds: 0};
...
var $author$project$PaceCalculator$calculatePaceSeconds = F2(
	function (distance, totalTime) {
		return totalTime / distance;
	});
var $author$project$PaceCalculator$calculateTotalSeconds = F3(
...
var $author$project$PaceCalculator$parseFloat = function (string) {
	return A2(
		$elm$core$Maybe$withDefault,
		0,
		$elm$core$String$toFloat(string));
};
var $author$project$PaceCalculator$update = F2(
	function (msg, model) {
		switch (msg.$) {
			case 'ChangeDistance':
				var string = msg.a;
...
var $author$project$PaceCalculator$ChangeMinutes = function (a) {
	return {$: 'ChangeMinutes', a: a};
};
...
var $author$project$PaceCalculator$viewResults = F4(
	function (distance, unit, kmPace, milePace) {
		return ((distance > 0) && ((kmPace > 0) && (unit !== 'none'))) ? A2(
			$elm$html$Html$span,
			_List_Nil,
			_List_fromArray(
				[
			...
			[
					...
					[
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$elm$html$Html$Attributes$class('timeFields')
									]),
								_List_fromArray(
									[
										A2(
								...
								_List_fromArray(
									[
										$elm$html$Html$Attributes$class('distanceFields')
									]),
								_List_fromArray(
									[
										A2(
										...
										_List_fromArray(
											[
												...
												_List_fromArray(
													[
														$elm$html$Html$Attributes$for('distance')
													]),
												_List_fromArray(
													[
														$elm$html$Html$text('distance')
										...
										_List_fromArray(
											[
												...
												_List_fromArray(
													[
														$elm$html$Html$Attributes$for('distanceUnits')
													]),
												_List_fromArray(
													[
														$elm$html$Html$text('Miles/Km')
													])),
												A2(
												$elm$html$Html$select,
												_List_fromArray(
													[
														$elm$html$Html$Attributes$name('distanceUnits'),
								...
								A4($author$project$PaceCalculator$viewResults, model.kilometres, model.distanceUnit, model.kmPace, model.milePace)
							]))
					])),
				A2(
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$Attributes$id('footerText')
							]),
						_List_fromArray(
							[
								$elm$html$Html$text('Pace Calculator by Matt Charlton')
							])),
						A2(
						$elm$html$Html$p,
						_List_fromArray(
...
var $author$project$PaceCalculator$main = $elm$browser$Browser$sandbox(
	{init: $author$project$PaceCalculator$initialModel, update: $author$project$PaceCalculator$update, view: $author$project$PaceCalculator$view});
_Platform_export({'PaceCalculator':{'init':$author$project$PaceCalculator$main(
